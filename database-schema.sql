...
Generated from `prisma/schema.prisma` via `prisma migrate diff --from-empty --to-schema-datamodel ... --script`. Do not hand-edit — regenerate by running:

    npx prisma migrate diff --from-empty --to-schema-datamodel prisma/schema.prisma --script

```sql
-- Extensions required by the schema. Run BEFORE the generated DDL below.
...
-- HNSW index for semantic search over embedding column (not modeled by Prisma).
